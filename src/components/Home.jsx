...
<Nav />
    <div className="grid grid-cols-2" >
        <div className="ml-5 text-wrap">
            ...
            <p className="mt-10 text-lg great-vibes-regular ">Ce site permet de faire une demande de devis concernant des prestations sur une application ou un site web. Nous sommes des développeurs avec une grande expérience et nous avons déja eu quelques clients tous satisfait par notre travail :</p>
                ...
                <div className="flex items-start gap-50 mt-20">
                    ...
                    <button className="mt-15 text-white bg-rose-200 hover:bg-rose-300 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button" onClick={handleClick}>Faire une demande</button>
                </div>
        </div>
